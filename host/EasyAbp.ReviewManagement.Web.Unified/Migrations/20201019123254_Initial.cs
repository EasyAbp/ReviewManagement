...
namespace EasyAbp.ReviewManagement.Web.Unified.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "EasyAbpReviewManagementReviewDetails",
                columns: table => new
                {
                    Id = table.Column<Guid>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EasyAbpReviewManagementReviewDetails", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "EasyAbpReviewManagementReviews",
                columns: table => new
                {
                    Id = table.Column<Guid>(nullable: false),
                    ExtraProperties = table.Column<string>(nullable: true),
                    ...
                    IsPublic = table.Column<bool>(nullable: false),
                    ReviewDetailId = table.Column<Guid>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EasyAbpReviewManagementReviews", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EasyAbpReviewManagementReviews_EasyAbpReviewManagementReviewDetails_ReviewDetailId",
                        column: x => x.ReviewDetailId,
                        principalTable: "EasyAbpReviewManagementReviewDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EasyAbpReviewManagementReviews_ReviewDetailId",
